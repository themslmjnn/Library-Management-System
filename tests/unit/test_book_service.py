...
class TestCreateBook:
    ...
    async def test_same_title_different_author_is_allowed(self, test_db, system_admin):
        ...
        result = await BookService.add_book(test_db, book_to_be_created, system_admin.id)
...
class TestUpdateBook:
    ...
    async def test_reject_duplicate_fields(self, test_db: AsyncSession, system_admin: User):
        ...
        with pytest.raises(BookAlreadyExistsError):
            await BookService.update_book(test_db, system_admin.id, update_request, book_to_be_updated.id)
